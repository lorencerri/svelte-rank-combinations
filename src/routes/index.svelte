...
<div class="navbar header ">
	...
	<div class="navbar-end">
		<label class="swap swap-rotate text-4xl pr-1">
...
<div class="p-8 flex justify-center">
	{#if state}
		<div class="grid grid-cols-1 pl-8 pr-8 max-w-[800px] min-w-[50vw] h-[20px]">
	...
	{:else}
		<div class="grid grid-cols-6 pl-8 pr-8 max-w-[800px] h-[20px]">
			...
			<div class="col-span-6">
				<button class="btn btn-success w-full max-w-full mb-2" on:click={addOption}>
					+ New Option
				</button>
			</div>
